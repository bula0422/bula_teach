...
國語注音符號手冊數位版－開放部件著作權利聲明

一、本檔案內含之注音符號動畫XML、SVG檔，以及相關音檔歡迎各界利用，獨立採「創用CC 姓名標示 4.0 國際版本」授權條款提供，可與國語注音符號手冊分隔另行下載。利用此些檔案，視為符合政府資料開放授權條款之規定。

二、「顯名聲明／姓名標示」部分請依以下方式進行標示：
